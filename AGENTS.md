...
This file is the quick-reference operating contract for openssl-sys-kotlin. The longer
...
openssl-sys-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`openssl-sys`](https://crates.io/crates/openssl-sys). Upstream Rust is the behavioral oracle while the

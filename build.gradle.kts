...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            implementation(libs.bundles.opensslsys.commonMain)
        }
...
dependencies {
    ...
    add("codeqlSourceClasspath", libs.kotlin.stdlib.jvm)
    add("codeqlSourceClasspath", libs.kotlinx.coroutines.core.jvm)
    add("codeqlSourceClasspath", libs.kotlinx.serialization.core.jvm)
    add("codeqlSourceClasspath", libs.kotlinx.serialization.json.jvm)
    add("codeqlSourceClasspath", libs.kotlinx.datetime.jvm)
    add("codeqlSourceClasspath", libs.collections.immutable.jvm)
